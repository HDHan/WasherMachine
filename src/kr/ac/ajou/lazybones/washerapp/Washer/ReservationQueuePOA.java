 ...
 implements kr.ac.ajou.lazybones.washerapp.Washer.ReservationQueueOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("enqueue", new java.lang.Integer (2));
    _methods.put ("dequeue", new java.lang.Integer (3));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 2:  // Washer/ReservationQueue/enqueue
       {
         String who = in.read_string ();
       ...
       case 3:  // Washer/ReservationQueue/dequeue
       {
         kr.ac.ajou.lazybones.washerapp.Washer.Reservation $result = null;
         $result = this.dequeue ();
         out = $rh.createReply();
       ...
       case 4:  // Washer/ReservationQueue/isEmpty
       {
         boolean $result = false;
         $result = this.isEmpty ();
         out = $rh.createReply();
