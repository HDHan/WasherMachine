...
public interface ReservationQueueOperations 
{
  ...
  kr.ac.ajou.lazybones.washerapp.Washer.Reservation[] reservationWaitingTimes ();
  kr.ac.ajou.lazybones.washerapp.Washer.Reservation[] reservationWaitingTimesBy (String who);
  int size ();
